const sourceLoader = {
    ...
    load: function (type, src, id) {
        ...
        if (type == 'audio') {
            ...
            const resolvedSrc = (typeof globalThis._$ !== 'undefined' && typeof globalThis._$.resolveBgmSrc === 'function')
                ? globalThis._$.resolveBgmSrc(src)
                : src;
            source.src = resolvedSrc;//Pose after listener to prevent fired early
            sourceLoader.sources[id] = source;
        }
        ...
        if (type == 'js') {
            ...
            node.onload = function () {
                //Load builder
                if (typeof _$ !== 'undefined' && _$.modules && _$.define) {
