                    ...
                    if (Resource.payCreditBill.call(this)){
                        ...
                        bullet.fire(() => {
                            ...
                            if (target.status!='dead'){
                                ...
                                const anime=new Animation.Lockdown({target:target,callback:() => {
            ...
            if (target instanceof Gobj){
                ...
                this.moveToward(target,250,() => {
                    if (Resource.payCreditBill.call(this)){
                        ...
                        const anime=new Animation.DefensiveMatrix({target:target,callback:() => {
        ...
        if (location){
            ...
            if (target instanceof Gobj){
                ...
                const irradiate=(chara) => {
                    //Irradiate effect
                    const anime=new Animation.Irradiate({target:chara,callback:() => {
