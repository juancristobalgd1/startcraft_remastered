...
export class Archon extends ProtossBuilding {
    name = "Archon";
    source = "Archon";
    portrait = "Archon";
    imgPos = {
...
ProtossBuilding.Archon = Archon;

export class DarkArchon extends ProtossBuilding {
    name = "DarkArchon";
    source = "DarkArchon";
    portrait = "DarkArchon";
    imgPos = {
...
ProtossBuilding.DarkArchon = DarkArchon;

export class Tranfer extends ProtossBuilding {
    name = "Tranfer";
    imgPos = {
        dock: {
...
ProtossBuilding.Tranfer = Tranfer;
