...
export class Factory extends TerranBuilding {
    name = "Factory";
...
TerranBuilding.Factory = Factory;

export class Starport extends TerranBuilding {
    name = "Starport";
    dieEffect = TerranBuildingBurst;
    imgPos = {
        dock: {
...
TerranBuilding.Starport = Starport;

export class ScienceFacility extends TerranBuilding {
...
TerranBuilding.ScienceFacility = ScienceFacility;

export class Armory extends TerranBuilding {
    name = "Armory";
    dieEffect = TerranBuildingBurst;
    imgPos = {
        dock: {
